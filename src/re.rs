...
// GLOBALS
pub static FILTER_FUNCTIONS: Lazy<Regex> =
    lazy_regex!(r"((?:cocos2d::)?(\w+::)*\w+)::([\w~]+\(.*\))");

pub static TYPEINFO_VTABLE_ETC: Lazy<Regex> =
    lazy_regex!(r"(?:typeinfo|vtable|thunk|guard variable)");

pub static OLD_JNI_INTERALS_CHECK: Lazy<Regex> = lazy_regex!(
    r#"^(?:_JNIEnv|internal|tinyxml2|ObjectDecoder|ObjectDecoderDelegate|pugi|__cxx|__gnu_cxx|std|llvm|tk|xml_|MD5)"#
);

pub static NEW_JNI_INTERNALS_CHECK: Lazy<Regex> = lazy_regex!(
    r#"^(?:_JNIEnv|internal|tinyxml2|cocos2d|DS_Dictionary|ObjectDecoder|ObjectDecoderDelegate|pugi|__cxx|__gnu_cxx|std|fmt|llvm|tk|xml_|MD5|rtsha1)"#
);
...
pub fn clean_function_sig(sig: String) -> String {
    ...
    multi_single_replace!(
        ...
        |_, c| format!("gd::set<{}>", c),
        r#"std::vector<(.*?), std::allocator<(.*?)> ?>"#,
        |_, t, _| format!("gd::vector<{}>", t),
        ...
        |_, k, v| format!("gd::map<{}, {}>", k, v),
        r#"std::unordered_map<(.*?), std::pair<double, double>, .*?> ?> ?> ?>"#,
        |_, k| format!("gd::unordered_map<{}, gd::pair<double, double>>", k),
        r#"std::unordered_map<(.*?), (.*?), .*?> ?> ?>"#,
        |_, k, v| format!("gd::unordered_map<{}, {}>", k, v),
        r#"unsinged long long"#,
        "uint64_t",
        r#"void \(cocos2d::CCObject::\*\)\(cocos2d::CCObject\*\)"#,
        "cocos2d::SEL_MenuHandler",
        r#"void \(cocos2d::CCObject::\*\)\(\)"#,
        ...
        r#"void \(cocos2d::CCObject::\*\)\(float\)"#,
        "cocos2d::SEL_SCHEDULE",
        r#"cocos2d::_ccColor3B"#,
        "cocos2d::ccColor3B",
        r#"cocos2d::_ccColor4B"#,
        "cocos2d::ccColor4B",
        r#"cocos2d::_ccColor4F"#,
        "cocos2d::ccColor4F",
        r#"cocos2d::_ccVertex2F"#,
        "cocos2d::_ccVertex2F",
        r#"cocos2d::_ccVertex3F"#,
        "cocos2d::_ccVertex3F",
